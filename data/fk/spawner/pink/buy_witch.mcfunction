...
execute if score witch spawner_pink matches 0 if score buy spawner_pink matches 0 run execute unless score pink Coins matches 240.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true,"color":"gray"}]
...
execute if score buy spawner_pink matches 1 run tellraw @a[team=pink] ["",{"text":"You succesfully bought the witch spawner lvl1","color":"gold"}]
...
execute if score witch spawner_pink matches 1 if score buy spawner_pink matches 0 unless score pink Coins matches 480.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true,"color":"gray"}]
...
execute if score buy spawner_pink matches 2 run tellraw @a[team=pink] ["",{"text":"You succesfully bought the witch spawner lvl2","color":"gold"}]
...
execute if score witch spawner_pink matches 2 if score buy spawner_pink matches 0 unless score pink Coins matches 960.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true,"color":"gray"}]
...
execute if score buy spawner_pink matches 3 run tellraw @a[team=pink] ["",{"text":"You succesfully bought the witch spawner lvl3","color":"gold"}]
...
execute if score witch spawner_pink matches 3 if score buy spawner_pink matches 0 unless score pink Coins matches 1920.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true,"color":"gray"}]
...
execute if score buy spawner_pink matches 4 run tellraw @a[team=pink] ["",{"text":"You succesfully bought the witch spawner lvl4","color":"gold"}]
