...
execute as @e[type=marker,tag=spawner_pink,limit=1] at @s run setblock ~-2 ~1 ~-11 minecraft:oak_wall_sign[facing=east]{Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function fk:spawner/pink/sign_skeleton_desactivate"}}',Text2:'{"text":"activated","color":"green"}',Text3:'{"text":""}'}
