...
execute if score skeleton spawner_yellow matches 0 if score buy spawner_yellow matches 0 run execute unless score yellow Coins matches 80.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true,"color":"gray"}]
...
execute if score buy spawner_yellow matches 1 run tellraw @a[team=yellow] ["",{"text":"You succesfully bought the skeleton spawner lvl1","color":"gold"}]
...
execute if score skeleton spawner_yellow matches 1 if score buy spawner_yellow matches 0 unless score yellow Coins matches 160.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true,"color":"gray"}]
...
execute if score buy spawner_yellow matches 2 run tellraw @a[team=yellow] ["",{"text":"You succesfully bought the skeleton spawner lvl2","color":"gold"}]
...
execute if score skeleton spawner_yellow matches 2 if score buy spawner_yellow matches 0 unless score yellow Coins matches 320.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true,"color":"gray"}]
...
execute if score buy spawner_yellow matches 3 run tellraw @a[team=yellow] ["",{"text":"You succesfully bought the skeleton spawner lvl3","color":"gold"}]
...
execute if score skeleton spawner_yellow matches 3 if score buy spawner_yellow matches 0 unless score yellow Coins matches 640.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true,"color":"gray"}]
...
execute if score buy spawner_yellow matches 4 run tellraw @a[team=yellow] ["",{"text":"You succesfully bought the skeleton spawner lvl4","color":"gold"}]
