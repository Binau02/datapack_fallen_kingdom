...
execute if score skeleton spawner_black matches 0 if score buy spawner_black matches 0 run execute unless score black Coins matches 80.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true,"color":"gray"}]
...
execute if score skeleton spawner_black matches 1 if score buy spawner_black matches 0 unless score black Coins matches 160.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true,"color":"gray"}]
...
execute if score skeleton spawner_black matches 2 if score buy spawner_black matches 0 unless score black Coins matches 320.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true,"color":"gray"}]
...
execute if score skeleton spawner_black matches 3 if score buy spawner_black matches 0 unless score black Coins matches 640.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true,"color":"gray"}]
