...
execute if score evoker spawner_white matches 0 if score buy spawner_white matches 0 run execute unless score white Coins matches 160.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true,"color":"gray"}]
...
execute as @e[type=marker,tag=spawner_white,limit=1] at @s if score buy spawner_white matches 1 run data merge block ~-9 ~2 ~2 {Text2:'{"text":"lvl 1"}',Text4:'{"text":"lvl 2 320$"}'}
execute if score buy spawner_white matches 1 run function fk:spawner/white/sign_evoker_activate
execute if score buy spawner_white matches 1 run tellraw @a[team=white] ["",{"text":"You succesfully bought the evoker spawner lvl1","color":"gold"}]
...
execute if score evoker spawner_white matches 1 if score buy spawner_white matches 0 unless score white Coins matches 320.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true,"color":"gray"}]
...
execute as @e[type=marker,tag=spawner_white,limit=1] at @s if score buy spawner_white matches 2 run data merge block ~-9 ~2 ~2 {Text2:'{"text":"lvl 2"}',Text4:'{"text":"lvl 3 640$"}'}
execute if score buy spawner_white matches 2 run function fk:spawner/white/sign_evoker_activate
execute if score buy spawner_white matches 2 run tellraw @a[team=white] ["",{"text":"You succesfully bought the evoker spawner lvl2","color":"gold"}]
...
execute if score evoker spawner_white matches 2 if score buy spawner_white matches 0 unless score white Coins matches 640.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true,"color":"gray"}]
...
execute as @e[type=marker,tag=spawner_white,limit=1] at @s if score buy spawner_white matches 3 run data merge block ~-9 ~2 ~2 {Text2:'{"text":"lvl 3"}',Text4:'{"text":"lvl 4 1280$"}'}
execute if score buy spawner_white matches 3 run function fk:spawner/white/sign_evoker_activate
execute if score buy spawner_white matches 3 run tellraw @a[team=white] ["",{"text":"You succesfully bought the evoker spawner lvl3","color":"gold"}]
...
execute if score evoker spawner_white matches 3 if score buy spawner_white matches 0 unless score white Coins matches 1280.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true,"color":"gray"}]
...
execute if score buy spawner_white matches 4 run tellraw @a[team=white] ["",{"text":"You succesfully bought the evoker spawner lvl4","color":"gold"}]
