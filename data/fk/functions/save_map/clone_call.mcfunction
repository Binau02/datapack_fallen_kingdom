execute if score clone_timer clone matches 0 run function fk:save_map/clone_parameters
...
execute if score clone_timer clone matches 5 run function fk:save_map/clone
execute if score clone_timer clone matches 5 run schedule clear fk:save_map/clone_call
...
execute if score clone_timer clone matches 0..5 run schedule function fk:save_map/clone_call 1s
