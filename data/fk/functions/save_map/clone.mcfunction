...
execute unless score Ziter clone = LIMIT clone run schedule function fk:save_map/clone 10t
...
execute if score Ziter clone = LIMIT clone run function fk:save_map/clone_finished
