...
execute if score @s capture_score matches 1.. if entity @s[team=blue] at @s run fill ~-1 ~-1 ~-1 ~1 ~-1 ~1 blue_concrete replace #fk:concrete
execute if score @s capture_score matches 1.. if entity @s[team=red] at @s run fill ~-1 ~-1 ~-1 ~1 ~-1 ~1 red_concrete replace #fk:concrete
execute if score @s capture_score matches 1.. if entity @s[team=yellow] at @s run fill ~-1 ~-1 ~-1 ~1 ~-1 ~1 yellow_concrete replace #fk:concrete
execute if score @s capture_score matches 1.. if entity @s[team=black] at @s run fill ~-1 ~-1 ~-1 ~1 ~-1 ~1 black_concrete replace #fk:concrete
execute if score @s capture_score matches 1.. if entity @s[team=white] at @s run fill ~-1 ~-1 ~-1 ~1 ~-1 ~1 white_concrete replace #fk:concrete
execute if score @s capture_score matches 1.. if entity @s[team=pink] at @s run fill ~-1 ~-1 ~-1 ~1 ~-1 ~1 pink_concrete replace #fk:concrete
execute if score @s capture_score matches 1.. if entity @s[team=purple] at @s run fill ~-1 ~-1 ~-1 ~1 ~-1 ~1 purple_concrete replace #fk:concrete
execute if score @s capture_score matches 1.. if entity @s[team=green] at @s run fill ~-1 ~-1 ~-1 ~1 ~-1 ~1 green_concrete replace #fk:concrete

execute at @s if score @s capture_score matches 10.. if block ~ ~-1 ~ gray_stained_glass if entity @s[team=blue] run tellraw @a [{"text":"L'équipe ","color":"gray"},{"text":"BLEU","color":"blue"},{"text":" a capturé un objectif.","color":"gray"}]
execute at @s if score @s capture_score matches 10.. if block ~ ~-1 ~ gray_stained_glass if entity @s[team=red] run tellraw @a [{"text":"L'équipe ","color":"gray"},{"text":"ROUGE","color":"red"},{"text":" a capturé un objectif.","color":"gray"}]
execute at @s if score @s capture_score matches 10.. if block ~ ~-1 ~ gray_stained_glass if entity @s[team=yellow] run tellraw @a [{"text":"L'équipe ","color":"gray"},{"text":"JAUNE","color":"yellow"},{"text":" a capturé un objectif.","color":"gray"}]
execute at @s if score @s capture_score matches 10.. if block ~ ~-1 ~ gray_stained_glass if entity @s[team=black] run tellraw @a [{"text":"L'équipe ","color":"gray"},{"text":"NOIR","color":"black"},{"text":" a capturé un objectif.","color":"gray"}]
execute at @s if score @s capture_score matches 10.. if block ~ ~-1 ~ gray_stained_glass if entity @s[team=white] run tellraw @a [{"text":"L'équipe ","color":"gray"},{"text":"BLANCHE","color":"white"},{"text":" a capturé un objectif.","color":"gray"}]
execute at @s if score @s capture_score matches 10.. if block ~ ~-1 ~ gray_stained_glass if entity @s[team=pink] run tellraw @a [{"text":"L'équipe ","color":"gray"},{"text":"ROSE","color":"light_purple"},{"text":" a capturé un objectif.","color":"gray"}]
execute at @s if score @s capture_score matches 10.. if block ~ ~-1 ~ gray_stained_glass if entity @s[team=purple] run tellraw @a [{"text":"L'équipe ","color":"gray"},{"text":"VIOLETTE","color":"dark_purple"},{"text":" a capturé un objectif.","color":"gray"}]
execute at @s if score @s capture_score matches 10.. if block ~ ~-1 ~ gray_stained_glass if entity @s[team=green] run tellraw @a [{"text":"L'équipe ","color":"gray"},{"text":"VERTE","color":"green"},{"text":" a capturé un objectif.","color":"gray"}]
execute at @s if score @s capture_score matches 10.. if block ~ ~-1 ~ gray_stained_glass run playsound block.anvil.place master @a ~ ~ ~ 4 2
execute at @s if score @s capture_score matches 10.. if block ~ ~-1 ~ gray_stained_glass run particle minecraft:wax_off ~ ~ ~ 1.5 1.5 1.5 5 100 force
execute at @s if score @s capture_score matches 10.. if block ~ ~-1 ~ gray_stained_glass run particle minecraft:totem_of_undying ~ ~ ~ 2 1 2 0.5 50 force
