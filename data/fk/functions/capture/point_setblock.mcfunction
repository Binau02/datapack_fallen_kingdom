...
execute if score @s capture_score matches 1.. if entity @s[team=blue] run fill ~-1 ~-1 ~-1 ~1 ~-1 ~1 light_blue_concrete replace #fk:concrete
...
execute if score @s capture_score matches 1.. if entity @s[team=green] run fill ~-1 ~-1 ~-1 ~1 ~-1 ~1 lime_concrete replace #fk:concrete
...
execute if score @s capture_score matches 10.. if entity @s[team=blue] run setblock ~ ~-1 ~ light_blue_stained_glass
...
execute if score @s capture_score matches 10.. if entity @s[team=green] run setblock ~ ~-1 ~ lime_stained_glass
