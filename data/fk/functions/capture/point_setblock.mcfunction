...
execute if score @s capture_score matches 10.. if block ~ ~-1 ~ gray_stained_glass if entity @s[team=blue] run tellraw @a [{"text":"[","color":"white"},{"text":"FK","color":"gold"},{"text":"] ","color":"white"},{"text":"L'équipe ","color":"gray"},{"text":"BLEU","color":"blue"},{"text":" a capturé un objectif.","color":"gray"}]
execute if score @s capture_score matches 10.. if block ~ ~-1 ~ gray_stained_glass if entity @s[team=red] run tellraw @a [{"text":"[","color":"white"},{"text":"FK","color":"gold"},{"text":"] ","color":"white"},{"text":"L'équipe ","color":"gray"},{"text":"ROUGE","color":"red"},{"text":" a capturé un objectif.","color":"gray"}]
execute if score @s capture_score matches 10.. if block ~ ~-1 ~ gray_stained_glass if entity @s[team=yellow] run tellraw @a [{"text":"[","color":"white"},{"text":"FK","color":"gold"},{"text":"] ","color":"white"},{"text":"L'équipe ","color":"gray"},{"text":"JAUNE","color":"yellow"},{"text":" a capturé un objectif.","color":"gray"}]
execute if score @s capture_score matches 10.. if block ~ ~-1 ~ gray_stained_glass if entity @s[team=black] run tellraw @a [{"text":"[","color":"white"},{"text":"FK","color":"gold"},{"text":"] ","color":"white"},{"text":"L'équipe ","color":"gray"},{"text":"NOIR","color":"black"},{"text":" a capturé un objectif.","color":"gray"}]
execute if score @s capture_score matches 10.. if block ~ ~-1 ~ gray_stained_glass if entity @s[team=white] run tellraw @a [{"text":"[","color":"white"},{"text":"FK","color":"gold"},{"text":"] ","color":"white"},{"text":"L'équipe ","color":"gray"},{"text":"BLANCHE","color":"white"},{"text":" a capturé un objectif.","color":"gray"}]
execute if score @s capture_score matches 10.. if block ~ ~-1 ~ gray_stained_glass if entity @s[team=pink] run tellraw @a [{"text":"[","color":"white"},{"text":"FK","color":"gold"},{"text":"] ","color":"white"},{"text":"L'équipe ","color":"gray"},{"text":"ROSE","color":"light_purple"},{"text":" a capturé un objectif.","color":"gray"}]
execute if score @s capture_score matches 10.. if block ~ ~-1 ~ gray_stained_glass if entity @s[team=purple] run tellraw @a [{"text":"[","color":"white"},{"text":"FK","color":"gold"},{"text":"] ","color":"white"},{"text":"L'équipe ","color":"gray"},{"text":"VIOLETTE","color":"dark_purple"},{"text":" a capturé un objectif.","color":"gray"}]
execute if score @s capture_score matches 10.. if block ~ ~-1 ~ gray_stained_glass if entity @s[team=green] run tellraw @a [{"text":"[","color":"white"},{"text":"FK","color":"gold"},{"text":"] ","color":"white"},{"text":"L'équipe ","color":"gray"},{"text":"VERTE","color":"green"},{"text":" a capturé un objectif.","color":"gray"}]
