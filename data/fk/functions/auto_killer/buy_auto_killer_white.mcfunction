...
execute if score buy spawner_white matches 1 run execute as @e[type=marker,tag=spawner_white,limit=1] at @s run data merge block ~-10 ~2 ~-2 {Text1:'{"text":"auto-killer lvl 1","clickEvent":{"action":"run_command","value":"function fk:auto_killer/buy_auto_killer_white"}}',Text2:'{"text":""}',Text3:'{"text":""}',Text4:'{"text":"lvl 2 2000$"}'}
...
execute if score buy spawner_white matches 2 run execute as @e[type=marker,tag=spawner_white,limit=1] at @s run data merge block ~-10 ~2 ~-2 {Text1:'{"text":"auto-killer lvl 2","clickEvent":{"action":"run_command","value":"function fk:auto_killer/buy_auto_killer_white"}}',Text2:'{"text":""}',Text3:'{"text":""}',Text4:'{"text":"lvl 3 4000$"}'}
...
execute if score buy spawner_white matches 3 run execute as @e[type=marker,tag=spawner_white,limit=1] at @s run data merge block ~-10 ~2 ~-2 {Text1:'{"text":"auto-killer lvl 3","clickEvent":{"action":"run_command","value":"function fk:auto_killer/buy_auto_killer_white"}}',Text2:'{"text":""}',Text3:'{"text":""}',Text4:'{"text":"lvl 4 8000$"}'}
...
execute if score buy spawner_white matches 4 run execute as @e[type=marker,tag=spawner_white,limit=1] at @s run data merge block ~-10 ~2 ~-2 {Text1:'{"text":"auto-killer lvl 4","clickEvent":{"action":"run_command","value":"function fk:auto_killer/buy_auto_killer_white"}}',Text2:'{"text":""}',Text3:'{"text":""}',Text4:'{"text":""}'}
