...
execute if score buy spawner_purple matches 2 run say mettre le data merge pour changer panneau
...
execute if score buy spawner_purple matches 3 run say mettre le data merge pour changer panneau
...
execute if score buy spawner_purple matches 4 run say mettre le data merge pour changer panneau
