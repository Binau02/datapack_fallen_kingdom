...
execute if score skeleton spawner_white matches 0 if score buy spawner_white matches 0 run execute unless score white Coins matches 80.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true}]
...
execute if score skeleton spawner_white matches 1 if score buy spawner_white matches 0 unless score white Coins matches 160.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true}]
...
execute if score skeleton spawner_white matches 2 if score buy spawner_white matches 0 unless score white Coins matches 320.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true}]
...
execute if score skeleton spawner_white matches 3 if score buy spawner_white matches 0 unless score white Coins matches 640.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true}]
