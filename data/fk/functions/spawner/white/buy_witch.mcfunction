...
execute as @e[type=marker,tag=spawner_pink,limit=1] at @s if score buy spawner_white matches 1 run data merge block ~-8 ~2 ~-2 {Text2:'{"text":"lvl 1"}',Text4:'{"text":"lvl 2 480$"}'}
...
execute as @e[type=marker,tag=spawner_pink,limit=1] at @s if score buy spawner_white matches 2 run data merge block ~-8 ~2 ~-2 {Text2:'{"text":"lvl 2"}',Text4:'{"text":"lvl 3 960$"}'}
...
execute as @e[type=marker,tag=spawner_pink,limit=1] at @s if score buy spawner_white matches 3 run data merge block ~-8 ~2 ~-2 {Text2:'{"text":"lvl 3"}',Text4:'{"text":"lvl 4 1920$"}'}
...
execute as @e[type=marker,tag=spawner_pink,limit=1] at @s if score buy spawner_white matches 4 run data merge block ~-8 ~2 ~-2 {Text2:'{"text":"lvl 4"}',Text4:'{"text":""}'}
