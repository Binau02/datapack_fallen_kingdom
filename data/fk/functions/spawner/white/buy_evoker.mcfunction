...
execute if score evoker spawner_white matches 0 if score buy spawner_white matches 0 run execute unless score white Coins matches 160.. run tellraw @s "You don't have enough coins"
...
execute if score buy spawner_white matches 1 run tellraw @a[team=white] "You succesfully bought the evoker spawner lvl1"
...
execute if score evoker spawner_white matches 1 if score buy spawner_white matches 0 unless score white Coins matches 320.. run tellraw @s "You don't have enough coins"
...
execute if score buy spawner_white matches 1 run tellraw @a[team=white] "You succesfully bought the evoker spawner lvl2"
...
execute if score evoker spawner_white matches 2 if score buy spawner_white matches 0 unless score white Coins matches 640.. run tellraw @s "You don't have enough coins"
...
execute if score buy spawner_white matches 1 run tellraw @a[team=white] "You succesfully bought the evoker spawner lvl3"
...
execute if score evoker spawner_white matches 3 if score buy spawner_white matches 0 unless score white Coins matches 1280.. run tellraw @s "You don't have enough coins"
...
execute if score buy spawner_white matches 1 run tellraw @a[team=white] "You succesfully bought the evoker spawner lvl4"
