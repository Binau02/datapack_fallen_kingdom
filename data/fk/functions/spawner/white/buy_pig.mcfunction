...
execute if score buy spawner_white matches 1 run data merge block ~-2 ~2 ~-12 {Text2:'["",{"text":"lvl "},{"score":{"name":"pig","objective":"spawner_white"}}]',Text4:'{"text":"lvl 2 40$"}'}
...
execute if score buy spawner_white matches 1 run data merge block ~-2 ~2 ~-12 {Text2:'["",{"text":"lvl "},{"score":{"name":"pig","objective":"spawner_white"}}]',Text4:'{"text":"lvl 3 80$"}'}
...
execute if score buy spawner_white matches 1 run data merge block ~-2 ~2 ~-12 {Text2:'["",{"text":"lvl "},{"score":{"name":"pig","objective":"spawner_white"}}]',Text4:'{"text":"lvl 4 160$"}'}
...
execute if score buy spawner_white matches 1 run data merge block ~-2 ~2 ~-12 {Text2:'["",{"text":"lvl "},{"score":{"name":"pig","objective":"spawner_white"}}]',Text4:'{"text":""}'}
