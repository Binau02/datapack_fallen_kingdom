...
execute if score pig spawner_white matches 0 if score buy spawner_white matches 0 run execute if score white Coins matches 20.. run scoreboard players set buy spawner_white 1
...
execute as @e[type=marker,tag=spawner_pink,limit=1] at @s if score buy spawner_white matches 1 run data merge block ~-12 ~2 ~2 {Text2:'{"text":"lvl 1"}',Text4:'{"text":"lvl 2 40$"}'}
...
execute if score pig spawner_white matches 1 if score buy spawner_white matches 0 if score white Coins matches 40.. run scoreboard players set buy spawner_white 2
...
execute as @e[type=marker,tag=spawner_pink,limit=1] at @s if score buy spawner_white matches 2 run data merge block ~-12 ~2 ~2 {Text2:'{"text":"lvl 2"}',Text4:'{"text":"lvl 3 80$"}'}
...
execute if score pig spawner_white matches 2 if score buy spawner_white matches 0 if score white Coins matches 80.. run scoreboard players set buy spawner_white 3
...
execute as @e[type=marker,tag=spawner_pink,limit=1] at @s if score buy spawner_white matches 3 run data merge block ~-12 ~2 ~2 {Text2:'{"text":"lvl 3"}',Text4:'{"text":"lvl 4 160$"}'}
...
execute if score pig spawner_white matches 3 if score buy spawner_white matches 0 if score white Coins matches 160.. run scoreboard players set buy spawner_white 4
...
execute as @e[type=marker,tag=spawner_pink,limit=1] at @s if score buy spawner_white matches 4 run data merge block ~-12 ~2 ~2 {Text2:'{"text":"lvl 4"}',Text4:'{"text":""}'}
