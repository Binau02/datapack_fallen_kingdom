...
execute if score witch spawner_blue matches 0 if score buy spawner_blue matches 0 run execute unless score blue Coins matches 240.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true}]
...
execute if score witch spawner_blue matches 1 if score buy spawner_blue matches 0 unless score blue Coins matches 480.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true}]
...
execute if score witch spawner_blue matches 2 if score buy spawner_blue matches 0 unless score blue Coins matches 960.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true}]
...
execute if score witch spawner_blue matches 3 if score buy spawner_blue matches 0 unless score blue Coins matches 1920.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true}]
