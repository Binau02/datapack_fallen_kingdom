...
execute if score witch spawner_blue matches 0 if score buy spawner_blue matches 0 run execute unless score blue Coins matches 240.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true,"color":"gray"}]
...
execute if score buy spawner_blue matches 1 run tellraw @a[team=blue] ["",{"text":"You succesfully bought the witch spawner lvl1","color":"gold"}]
...
execute if score witch spawner_blue matches 1 if score buy spawner_blue matches 0 unless score blue Coins matches 480.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true,"color":"gray"}]
...
execute if score buy spawner_blue matches 2 run tellraw @a[team=blue] ["",{"text":"You succesfully bought the witch spawner lvl2","color":"gold"}]
...
execute if score witch spawner_blue matches 2 if score buy spawner_blue matches 0 unless score blue Coins matches 960.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true,"color":"gray"}]
...
execute if score buy spawner_blue matches 3 run tellraw @a[team=blue] ["",{"text":"You succesfully bought the witch spawner lvl3","color":"gold"}]
...
execute if score witch spawner_blue matches 3 if score buy spawner_blue matches 0 unless score blue Coins matches 1920.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true,"color":"gray"}]
...
execute if score buy spawner_blue matches 4 run tellraw @a[team=blue] ["",{"text":"You succesfully bought the witch spawner lvl4","color":"gold"}]
