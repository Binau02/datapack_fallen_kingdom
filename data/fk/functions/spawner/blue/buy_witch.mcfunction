...
execute if score buy spawner_blue matches 1 run data merge block ~-2 ~2 ~-8 {Text2:'["",{"text":"lvl "},{"score":{"name":"witch","objective":"spawner_blue"}}]',Text4:'{"text":"lvl 2 480$"}'}
...
execute if score buy spawner_blue matches 1 run data merge block ~-2 ~2 ~-8 {Text2:'["",{"text":"lvl "},{"score":{"name":"witch","objective":"spawner_blue"}}]',Text4:'{"text":"lvl 3 960$"}'}
...
execute if score buy spawner_blue matches 1 run data merge block ~-2 ~2 ~-8 {Text2:'["",{"text":"lvl "},{"score":{"name":"witch","objective":"spawner_blue"}}]',Text4:'{"text":"lvl 4 1920$"}'}
...
execute if score buy spawner_blue matches 1 run data merge block ~-2 ~2 ~-8 {Text2:'["",{"text":"lvl "},{"score":{"name":"witch","objective":"spawner_blue"}}]',Text4:'{"text":""}'}
