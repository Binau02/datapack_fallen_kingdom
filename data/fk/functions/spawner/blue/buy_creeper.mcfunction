...
execute if score creeper spawner_blue matches 0 if score buy spawner_blue matches 0 run execute unless score blue Coins matches 160.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true,"color":"gray"}]
...
execute if score buy spawner_blue matches 1 run tellraw @a[team=blue] ["",{"text":"You succesfully bought the creeper spawner lvl1","color":"gold"}]
...
execute if score creeper spawner_blue matches 1 if score buy spawner_blue matches 0 unless score blue Coins matches 320.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true,"color":"gray"}]
...
execute if score buy spawner_blue matches 2 run tellraw @a[team=blue] ["",{"text":"You succesfully bought the creeper spawner lvl2","color":"gold"}]
...
execute if score creeper spawner_blue matches 2 if score buy spawner_blue matches 0 unless score blue Coins matches 640.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true,"color":"gray"}]
...
execute if score buy spawner_blue matches 3 run tellraw @a[team=blue] ["",{"text":"You succesfully bought the creeper spawner lvl3","color":"gold"}]
...
execute if score creeper spawner_blue matches 3 if score buy spawner_blue matches 0 unless score blue Coins matches 1280.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true,"color":"gray"}]
...
execute if score buy spawner_blue matches 4 run tellraw @a[team=blue] ["",{"text":"You succesfully bought the creeper spawner lvl4","color":"gold"}]
