...
execute if score skeleton spawner_green matches 0 if score buy spawner_green matches 0 run execute unless score green Coins matches 80.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true,"color":"gray"}]
...
execute if score skeleton spawner_green matches 1 if score buy spawner_green matches 0 unless score green Coins matches 160.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true,"color":"gray"}]
...
execute if score skeleton spawner_green matches 2 if score buy spawner_green matches 0 unless score green Coins matches 320.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true,"color":"gray"}]
...
execute if score skeleton spawner_green matches 3 if score buy spawner_green matches 0 unless score green Coins matches 640.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true,"color":"gray"}]
