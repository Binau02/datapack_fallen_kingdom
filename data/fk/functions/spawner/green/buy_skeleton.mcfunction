...
execute if score skeleton spawner_green matches 0 if score buy spawner_green matches 0 run execute unless score green Coins matches 80.. run tellraw @s "You don't have enough coins"
...
execute if score buy spawner_green matches 1 run tellraw @a[team=green] "You succesfully bought the skeleton spawner lvl1"
...
execute if score skeleton spawner_green matches 1 if score buy spawner_green matches 0 unless score green Coins matches 160.. run tellraw @s "You don't have enough coins"
...
execute if score buy spawner_green matches 1 run tellraw @a[team=green] "You succesfully bought the skeleton spawner lvl2"
...
execute if score skeleton spawner_green matches 2 if score buy spawner_green matches 0 unless score green Coins matches 320.. run tellraw @s "You don't have enough coins"
...
execute if score buy spawner_green matches 1 run tellraw @a[team=green] "You succesfully bought the skeleton spawner lvl3"
...
execute if score skeleton spawner_green matches 3 if score buy spawner_green matches 0 unless score green Coins matches 640.. run tellraw @s "You don't have enough coins"
...
execute if score buy spawner_green matches 1 run tellraw @a[team=green] "You succesfully bought the skeleton spawner lvl4"
