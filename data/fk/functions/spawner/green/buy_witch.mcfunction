...
execute if score witch spawner_green matches 0 if score buy spawner_green matches 0 run execute unless score green Coins matches 240.. run tellraw @s "You don't have enough coins"
...
execute if score buy spawner_green matches 1 run tellraw @a[team=green] "You succesfully bought the "witch spawner lvl1
...
execute if score witch spawner_green matches 1 if score buy spawner_green matches 0 unless score green Coins matches 480.. run tellraw @s "You don't have enough coins"
...
execute if score buy spawner_green matches 1 run tellraw @a[team=green] "You succesfully bought the "witch spawner lvl2
...
execute if score witch spawner_green matches 2 if score buy spawner_green matches 0 unless score green Coins matches 960.. run tellraw @s "You don't have enough coins"
...
execute if score buy spawner_green matches 1 run tellraw @a[team=green] "You succesfully bought the "witch spawner lvl3
...
execute if score witch spawner_green matches 3 if score buy spawner_green matches 0 unless score green Coins matches 1920.. run tellraw @s "You don't have enough coins"
...
execute if score buy spawner_green matches 1 run tellraw @a[team=green] "You succesfully bought the "witch spawner lvl4
