...
execute if score hoglin spawner_green matches 0 if score buy spawner_green matches 0 run execute unless score green Coins matches 20.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true}]
...
execute if score hoglin spawner_green matches 1 if score buy spawner_green matches 0 unless score green Coins matches 40.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true}]
...
execute if score hoglin spawner_green matches 2 if score buy spawner_green matches 0 unless score green Coins matches 80.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true}]
...
execute if score hoglin spawner_green matches 3 if score buy spawner_green matches 0 unless score green Coins matches 160.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true}]
