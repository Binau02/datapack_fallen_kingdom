...
setblock ~-2 ~2 ~10 air
execute if score auto_killer spawner_black matches 0 run setblock ~-2 ~2 ~10 oak_wall_sign[facing=east]{Text1:'{"text":"auto-killer lvl 0","clickEvent":{"action":"run_command","value":"function fk:auto_killer/buy_auto_killer_black"}}',Text2:'{"text":""}',Text3:'{"text":""}',Text4:'{"text":"lvl 1 1000$"}'}
execute if score auto_killer spawner_black matches 1 run setblock ~-2 ~2 ~10 oak_wall_sign[facing=east]{Text1:'{"text":"auto-killer lvl 1","clickEvent":{"action":"run_command","value":"function fk:auto_killer/buy_auto_killer_black"}}',Text2:'{"text":""}',Text3:'{"text":""}',Text4:'{"text":"lvl 2 2000$"}'}
execute if score auto_killer spawner_black matches 2 run setblock ~-2 ~2 ~10 oak_wall_sign[facing=east]{Text1:'{"text":"auto-killer lvl 2","clickEvent":{"action":"run_command","value":"function fk:auto_killer/buy_auto_killer_black"}}',Text2:'{"text":""}',Text3:'{"text":""}',Text4:'{"text":"lvl 3 4000$"}'}
execute if score auto_killer spawner_black matches 3 run setblock ~-2 ~2 ~10 oak_wall_sign[facing=east]{Text1:'{"text":"auto-killer lvl 3","clickEvent":{"action":"run_command","value":"function fk:auto_killer/buy_auto_killer_black"}}',Text2:'{"text":""}',Text3:'{"text":""}',Text4:'{"text":"lvl 4 8000$"}'}
execute if score auto_killer spawner_black matches 4 run setblock ~-2 ~2 ~10 oak_wall_sign[facing=east]{Text1:'{"text":"auto-killer lvl 4","clickEvent":{"action":"run_command","value":"function fk:auto_killer/buy_auto_killer_black"}}',Text2:'{"text":""}',Text3:'{"text":""}',Text4:'{"text":""}'}
