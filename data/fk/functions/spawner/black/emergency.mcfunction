...
data merge block ~-2 ~2 ~-12 {Text1:'{"text":"pig"}',Text2:'["",{"text":"lvl "},{"score":{"name":"pig","objective":"spawner_black}}]'}
execute if score pig spawner_black matches 0 run data merge block ~-2 ~2 ~-12 {Text4:'["",{"text":"lvl 1 20$"}'}
execute if score pig spawner_black matches 1 run data merge block ~-2 ~2 ~-12 {Text4:'["",{"text":"lvl 2 40$"}'}
execute if score pig spawner_black matches 2 run data merge block ~-2 ~2 ~-12 {Text4:'["",{"text":"lvl 3 80$"}'}
execute if score pig spawner_black matches 3 run data merge block ~-2 ~2 ~-12 {Text4:'["",{"text":"lvl 4 160$"}'}
function fk:spawner/black/sign_skeleton_desactivate
data merge block ~-2 ~2 ~-11 {Text1:'{"text":"skeleton"}',Text2:'["",{"text":"lvl "},{"score":{"name":"skeleton","objective":"spawner_black}}]'}
...
data merge block ~-2 ~2 ~-10 {Text1:'{"text":"creeper"}',Text2:'["",{"text":"lvl "},{"score":{"name":"creeper","objective":"spawner_black}}]'}
...
data merge block ~-2 ~2 ~-9 {Text1:'{"text":"blaze"}',Text2:'["",{"text":"lvl "},{"score":{"name":"blaze","objective":"spawner_black}}]'}
execute if score blaze spawner_black matches 0 run data merge block ~-2 ~2 ~-9 {Text4:'["",{"text":"lvl 1 160$"}'}
execute if score blaze spawner_black matches 1 run data merge block ~-2 ~2 ~-9 {Text4:'["",{"text":"lvl 2 320$"}'}
execute if score blaze spawner_black matches 2 run data merge block ~-2 ~2 ~-9 {Text4:'["",{"text":"lvl 3 640$"}'}
execute if score blaze spawner_black matches 3 run data merge block ~-2 ~2 ~-9 {Text4:'["",{"text":"lvl 4 1280$"}'}
function fk:spawner/black/sign_witch_desactivate
data merge block ~-2 ~2 ~-8 {Text1:'{"text":"witch"}',Text2:'["",{"text":"lvl "},{"score":{"name":"witch","objective":"spawner_black}}]'}
