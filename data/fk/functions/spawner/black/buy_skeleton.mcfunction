...
execute if score buy spawner_black matches 1 run data merge block ~-2 ~2 ~-11 {Text2:'["",{"text":"lvl "},{"score":{"name":"skeleton","objective":"spawner_black"}}]',Text4:'{"text":"lvl 2 160$"}'}
...
execute if score buy spawner_black matches 1 run data merge block ~-2 ~2 ~-11 {Text2:'["",{"text":"lvl "},{"score":{"name":"skeleton","objective":"spawner_black"}}]',Text4:'{"text":"lvl 3 320$"}'}
...
execute if score buy spawner_black matches 1 run data merge block ~-2 ~2 ~-11 {Text2:'["",{"text":"lvl "},{"score":{"name":"skeleton","objective":"spawner_black"}}]',Text4:'{"text":"lvl 4 640$"}'}
...
execute if score buy spawner_black matches 1 run data merge block ~-2 ~2 ~-11 {Text2:'["",{"text":"lvl "},{"score":{"name":"skeleton","objective":"spawner_black"}}]',Text4:'{"text":""}'}
