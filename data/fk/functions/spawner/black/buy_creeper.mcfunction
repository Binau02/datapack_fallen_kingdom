...
execute if score creeper spawner_black matches 0 if score buy spawner_black matches 0 run execute if score money_black money_black matches 160.. run scoreboard players set buy spawner_black 1
...
execute if score buy spawner_black matches 1 run data merge block ~-2 ~2 ~-10 {Text2:'["",{"text":"lvl "},{"score":{"name":"creeper","objective":"spawner_black"}}]',Text4:'{"text":"lvl 2 320$"}'}
...
execute if score creeper spawner_black matches 1 if score buy spawner_black matches 0 if score money_black money_black matches 320.. run scoreboard players set buy spawner_black 2
...
execute if score buy spawner_black matches 1 run data merge block ~-2 ~2 ~-10 {Text2:'["",{"text":"lvl "},{"score":{"name":"creeper","objective":"spawner_black"}}]',Text4:'{"text":"lvl 3 640$"}'}
...
execute if score creeper spawner_black matches 2 if score buy spawner_black matches 0 if score money_black money_black matches 640.. run scoreboard players set buy spawner_black 3
...
execute if score buy spawner_black matches 1 run data merge block ~-2 ~2 ~-10 {Text2:'["",{"text":"lvl "},{"score":{"name":"creeper","objective":"spawner_black"}}]',Text4:'{"text":"lvl 4 1280$"}'}
...
execute if score creeper spawner_black matches 3 if score buy spawner_black matches 0 if score money_black money_black matches 1280.. run scoreboard players set buy spawner_black 4
...
execute if score buy spawner_black matches 1 run data merge block ~-2 ~2 ~-10 {Text2:'["",{"text":"lvl "},{"score":{"name":"creeper","objective":"spawner_black"}}]',Text4:'{"text":""}'}
