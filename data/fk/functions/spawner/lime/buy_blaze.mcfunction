...
execute if score buy spawner_lime matches 1 run data merge block ~-2 ~2 ~-9 {Text2:'["",{"text":"lvl "},{"score":{"name":"blaze","objective":"spawner_lime"}}]',Text4:'{"text":"lvl 2 320$"}'}
...
execute if score buy spawner_lime matches 1 run data merge block ~-2 ~2 ~-9 {Text2:'["",{"text":"lvl "},{"score":{"name":"blaze","objective":"spawner_lime"}}]',Text4:'{"text":"lvl 3 640$"}'}
...
execute if score buy spawner_lime matches 1 run data merge block ~-2 ~2 ~-9 {Text2:'["",{"text":"lvl "},{"score":{"name":"blaze","objective":"spawner_lime"}}]',Text4:'{"text":"lvl 4 1280$"}'}
...
execute if score buy spawner_lime matches 1 run data merge block ~-2 ~2 ~-9 {Text2:'["",{"text":"lvl "},{"score":{"name":"blaze","objective":"spawner_lime"}}]',Text4:'{"text":""}'}
