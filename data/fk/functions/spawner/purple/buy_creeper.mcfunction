...
execute if score creeper spawner_purple matches 0 if score buy spawner_purple matches 0 run execute unless score purple Coins matches 160.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true}]
...
execute if score creeper spawner_purple matches 1 if score buy spawner_purple matches 0 unless score purple Coins matches 320.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true}]
...
execute if score creeper spawner_purple matches 2 if score buy spawner_purple matches 0 unless score purple Coins matches 640.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true}]
...
execute if score creeper spawner_purple matches 3 if score buy spawner_purple matches 0 unless score purple Coins matches 1280.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true}]
