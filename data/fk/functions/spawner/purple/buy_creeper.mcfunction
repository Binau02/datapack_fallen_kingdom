...
execute if score buy spawner_purple matches 1 run data merge block ~-2 ~2 ~-10 {Text2:'["",{"text":"lvl "},{"score":{"name":"creeper","objective":"spawner_purple"}}]',Text4:'{"text":"lvl 2 320$"}'}
...
execute if score buy spawner_purple matches 1 run data merge block ~-2 ~2 ~-10 {Text2:'["",{"text":"lvl "},{"score":{"name":"creeper","objective":"spawner_purple"}}]',Text4:'{"text":"lvl 3 640$"}'}
...
execute if score buy spawner_purple matches 1 run data merge block ~-2 ~2 ~-10 {Text2:'["",{"text":"lvl "},{"score":{"name":"creeper","objective":"spawner_purple"}}]',Text4:'{"text":"lvl 4 1280$"}'}
...
execute if score buy spawner_purple matches 1 run data merge block ~-2 ~2 ~-10 {Text2:'["",{"text":"lvl "},{"score":{"name":"creeper","objective":"spawner_purple"}}]',Text4:'{"text":""}'}
