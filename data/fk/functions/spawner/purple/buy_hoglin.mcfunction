...
execute if score hoglin spawner_purple matches 0 if score buy spawner_purple matches 0 run execute unless score purple Coins matches 20.. run tellraw @s "You don't have enough coins"
...
execute if score buy spawner_purple matches 1 run tellraw @a[team=purple] "You succesfully bought the hoglin spawner lvl1"
...
execute if score hoglin spawner_purple matches 1 if score buy spawner_purple matches 0 unless score purple Coins matches 40.. run tellraw @s "You don't have enough coins"
...
execute if score buy spawner_purple matches 1 run tellraw @a[team=purple] "You succesfully bought the hoglin spawner lvl2"
...
execute if score hoglin spawner_purple matches 2 if score buy spawner_purple matches 0 unless score purple Coins matches 80.. run tellraw @s "You don't have enough coins"
...
execute if score buy spawner_purple matches 1 run tellraw @a[team=purple] "You succesfully bought the hoglin spawner lvl3"
...
execute if score hoglin spawner_purple matches 3 if score buy spawner_purple matches 0 unless score purple Coins matches 160.. run tellraw @s "You don't have enough coins"
...
execute if score buy spawner_purple matches 1 run tellraw @a[team=purple] "You succesfully bought the hoglin spawner lvl4"
