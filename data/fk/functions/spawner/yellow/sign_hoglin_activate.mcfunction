...
execute as @e[type=marker,tag=spawner_yellow,limit=1] at @s run setblock ~2 ~1 ~12 minecraft:oak_wall_sign[facing=west]{Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function fk:spawner/yellow/sign_hoglin_desactivate"}}',Text2:'{"text":"activé","color":"green"}',Text3:'{"text":""}'}
