...
execute if score evoker spawner_yellow matches 0 if score buy spawner_yellow matches 0 run execute unless score yellow Coins matches 160.. run tellraw @s "You don't have enough coins"
...
execute if score buy spawner_yellow matches 1 run tellraw @a[team=yellow] "You succesfully bought the evoker spawner lvl1"
...
execute if score evoker spawner_yellow matches 1 if score buy spawner_yellow matches 0 unless score yellow Coins matches 320.. run tellraw @s "You don't have enough coins"
...
execute if score buy spawner_yellow matches 1 run tellraw @a[team=yellow] "You succesfully bought the evoker spawner lvl2"
...
execute if score evoker spawner_yellow matches 2 if score buy spawner_yellow matches 0 unless score yellow Coins matches 640.. run tellraw @s "You don't have enough coins"
...
execute if score buy spawner_yellow matches 1 run tellraw @a[team=yellow] "You succesfully bought the evoker spawner lvl3"
...
execute if score evoker spawner_yellow matches 3 if score buy spawner_yellow matches 0 unless score yellow Coins matches 1280.. run tellraw @s "You don't have enough coins"
...
execute if score buy spawner_yellow matches 1 run tellraw @a[team=yellow] "You succesfully bought the evoker spawner lvl4"
