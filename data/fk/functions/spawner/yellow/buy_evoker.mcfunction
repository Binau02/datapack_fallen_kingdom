...
execute if score evoker spawner_yellow matches 0 if score buy spawner_yellow matches 0 run execute if score money_yellow money_yellow matches 160.. run scoreboard players set buy spawner_yellow 1
...
execute if score evoker spawner_yellow matches 1 if score buy spawner_yellow matches 0 if score money_yellow money_yellow matches 320.. run scoreboard players set buy spawner_yellow 2
...
execute if score evoker spawner_yellow matches 2 if score buy spawner_yellow matches 0 if score money_yellow money_yellow matches 640.. run scoreboard players set buy spawner_yellow 3
...
execute if score evoker spawner_yellow matches 3 if score buy spawner_yellow matches 0 if score money_yellow money_yellow matches 1280.. run scoreboard players set buy spawner_yellow 4
