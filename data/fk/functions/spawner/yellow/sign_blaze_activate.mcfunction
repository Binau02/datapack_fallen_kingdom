...
execute as @e[type=marker,tag=spawner_yellow,limit=1] at @s run setblock ~-2 ~1 ~-11 minecraft:oak_wall_sign[facing=east]{Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function fk:spawner/yellow/sign_blaze_desactivate"}}',Text2:'{"text":"activé","color":"green"}',Text3:'{"text":""}'}
...
function fk:spawner/yellow/sign_blaze_desactivatefunction fk:spawner/yellow/sign_blaze_desactivatefunction fk:spawner/yellow/sign_blaze_desactivatefunction fk:spawner/yellow/sign_blaze_desactivate