...
execute if score witch spawner_yellow matches 0 if score buy spawner_yellow matches 0 run execute unless score yellow Coins matches 240.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true}]
...
execute if score witch spawner_yellow matches 1 if score buy spawner_yellow matches 0 unless score yellow Coins matches 480.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true}]
...
execute if score witch spawner_yellow matches 2 if score buy spawner_yellow matches 0 unless score yellow Coins matches 960.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true}]
...
execute if score witch spawner_yellow matches 3 if score buy spawner_yellow matches 0 unless score yellow Coins matches 1920.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true}]
