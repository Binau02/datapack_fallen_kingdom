...
execute if score creeper spawner_yellow matches 0 if score buy spawner_yellow matches 0 run execute if score money_yellow money_yellow matches 160.. run scoreboard players set buy spawner_yellow 1
...
execute as @e[type=marker,tag=spawner_pink,limit=1] at @s if score buy spawner_yellow matches 1 run data merge block ~-2 ~2 ~-10 {Text2:'{"text":"lvl 1"}',Text4:'{"text":"lvl 2 320$"}'}
...
execute if score creeper spawner_yellow matches 1 if score buy spawner_yellow matches 0 if score money_yellow money_yellow matches 320.. run scoreboard players set buy spawner_yellow 2
...
execute as @e[type=marker,tag=spawner_pink,limit=1] at @s if score buy spawner_yellow matches 2 run data merge block ~-2 ~2 ~-10 {Text2:'{"text":"lvl 2"}',Text4:'{"text":"lvl 3 640$"}'}
...
execute if score creeper spawner_yellow matches 2 if score buy spawner_yellow matches 0 if score money_yellow money_yellow matches 640.. run scoreboard players set buy spawner_yellow 3
...
execute as @e[type=marker,tag=spawner_pink,limit=1] at @s if score buy spawner_yellow matches 3 run data merge block ~-2 ~2 ~-10 {Text2:'{"text":"lvl 3"}',Text4:'{"text":"lvl 4 1280$"}'}
...
execute if score creeper spawner_yellow matches 3 if score buy spawner_yellow matches 0 if score money_yellow money_yellow matches 1280.. run scoreboard players set buy spawner_yellow 4
...
execute as @e[type=marker,tag=spawner_pink,limit=1] at @s if score buy spawner_yellow matches 4 run data merge block ~-2 ~2 ~-10 {Text2:'{"text":"lvl 4"}',Text4:'{"text":""}'}
