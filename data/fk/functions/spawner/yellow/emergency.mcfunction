...
data merge block ~-2 ~2 ~-12 {Text1:'{"text":"pig"}',Text2:'["",{"text":"lvl "},{"score":{"name":"pig","objective":"spawner_yellow}}]'}
...
data merge block ~-2 ~2 ~-11 {Text1:'{"text":"skeleton"}',Text2:'["",{"text":"lvl "},{"score":{"name":"skeleton","objective":"spawner_yellow}}]'}
...
data merge block ~-2 ~2 ~-10 {Text1:'{"text":"creeper"}',Text2:'["",{"text":"lvl "},{"score":{"name":"creeper","objective":"spawner_yellow}}]'}
...
data merge block ~-2 ~2 ~-9 {Text1:'{"text":"blaze"}',Text2:'["",{"text":"lvl "},{"score":{"name":"blaze","objective":"spawner_yellow}}]'}
...
data merge block ~-2 ~2 ~-8 {Text1:'{"text":"witch"}',Text2:'["",{"text":"lvl "},{"score":{"name":"witch","objective":"spawner_yellow}}]'}
