...
execute if score creeper spawner_pink matches 0 if score buy spawner_pink matches 0 run execute if score money_pink money_pink matches 160.. run scoreboard players set buy spawner_pink 1
...
execute if score buy spawner_pink matches 1 run data merge block ~-2 ~2 ~-10 {Text2:'["",{"text":"lvl "},{"score":{"name":"creeper","objective":"spawner_pink"}}]',Text4:'{"text":"lvl 2 320$"}'}
...
execute if score creeper spawner_pink matches 1 if score buy spawner_pink matches 0 if score money_pink money_pink matches 320.. run scoreboard players set buy spawner_pink 2
...
execute if score buy spawner_pink matches 1 run data merge block ~-2 ~2 ~-10 {Text2:'["",{"text":"lvl "},{"score":{"name":"creeper","objective":"spawner_pink"}}]',Text4:'{"text":"lvl 3 640$"}'}
...
execute if score creeper spawner_pink matches 2 if score buy spawner_pink matches 0 if score money_pink money_pink matches 640.. run scoreboard players set buy spawner_pink 3
...
execute if score buy spawner_pink matches 1 run data merge block ~-2 ~2 ~-10 {Text2:'["",{"text":"lvl "},{"score":{"name":"creeper","objective":"spawner_pink"}}]',Text4:'{"text":"lvl 4 1280$"}'}
...
execute if score creeper spawner_pink matches 3 if score buy spawner_pink matches 0 if score money_pink money_pink matches 1280.. run scoreboard players set buy spawner_pink 4
...
execute if score buy spawner_pink matches 1 run data merge block ~-2 ~2 ~-10 {Text2:'["",{"text":"lvl "},{"score":{"name":"creeper","objective":"spawner_pink"}}]',Text4:'{"text":""}'}
