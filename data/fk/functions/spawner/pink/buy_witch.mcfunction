...
execute if score witch spawner_pink matches 0 if score buy spawner_pink matches 0 run execute unless score pink Coins matches 240.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true}]
...
execute if score witch spawner_pink matches 1 if score buy spawner_pink matches 0 unless score pink Coins matches 480.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true}]
...
execute if score witch spawner_pink matches 2 if score buy spawner_pink matches 0 unless score pink Coins matches 960.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true}]
...
execute if score witch spawner_pink matches 3 if score buy spawner_pink matches 0 unless score pink Coins matches 1920.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true}]
