...
execute if score pig spawner_pink matches 0 if score buy spawner_pink matches 0 run execute if score pink Coins matches 20.. run scoreboard players set buy spawner_pink 1
...
execute if score pig spawner_pink matches 1 if score buy spawner_pink matches 0 if score pink Coins matches 40.. run scoreboard players set buy spawner_pink 2
...
execute if score pig spawner_pink matches 2 if score buy spawner_pink matches 0 if score pink Coins matches 80.. run scoreboard players set buy spawner_pink 3
...
execute if score pig spawner_pink matches 3 if score buy spawner_pink matches 0 if score pink Coins matches 160.. run scoreboard players set buy spawner_pink 4
