...
execute as @e[type=marker,tag=spawner_red,limit=1] at @s run setblock ~-2 ~1 ~-10 minecraft:oak_wall_sign[facing=east]{Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function fk:spawner/red/sign_skeleton_desactivate"}}',Text2:'{"text":"activé","color":"green"}',Text3:'{"text":""}'}
...
function fk:spawner/red/sign_skeleton_desactivatefunction fk:spawner/red/sign_skeleton_desactivatefunction fk:spawner/red/sign_skeleton_desactivatefunction fk:spawner/red/sign_skeleton_desactivate