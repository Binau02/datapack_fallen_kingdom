...
execute if score witch spawner_red matches 0 if score buy spawner_red matches 0 run execute unless score red Coins matches 240.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true}]
...
execute if score witch spawner_red matches 1 if score buy spawner_red matches 0 unless score red Coins matches 480.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true}]
...
execute if score witch spawner_red matches 2 if score buy spawner_red matches 0 unless score red Coins matches 960.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true}]
...
execute if score witch spawner_red matches 3 if score buy spawner_red matches 0 unless score red Coins matches 1920.. run tellraw @s ["",{"text":"You don't have enough coins","italic":true}]
