...
execute if score evoker spawner_red matches 0 if score buy spawner_red matches 0 run execute unless score red Coins matches 160.. run tellraw @s "You don't have enough coins"
...
execute if score buy spawner_red matches 1 run tellraw @a[team=red] "You succesfully bought the evoker spawner lvl1"
...
execute if score evoker spawner_red matches 1 if score buy spawner_red matches 0 unless score red Coins matches 320.. run tellraw @s "You don't have enough coins"
...
execute if score buy spawner_red matches 1 run tellraw @a[team=red] "You succesfully bought the evoker spawner lvl2"
...
execute if score evoker spawner_red matches 2 if score buy spawner_red matches 0 unless score red Coins matches 640.. run tellraw @s "You don't have enough coins"
...
execute if score buy spawner_red matches 1 run tellraw @a[team=red] "You succesfully bought the evoker spawner lvl3"
...
execute if score evoker spawner_red matches 3 if score buy spawner_red matches 0 unless score red Coins matches 1280.. run tellraw @s "You don't have enough coins"
...
execute if score buy spawner_red matches 1 run tellraw @a[team=red] "You succesfully bought the evoker spawner lvl4"
