...
data merge block ~-2 ~2 ~-12 {Text1:'{"clickEvent":{"action":"run_command","value":"function fk:spawner/red/buy_pig"},"text":"pig"}',Text2:'["",{"text":"lvl "},{"score":{"name":"pig","objective":"spawner_red"}}]'}
...
data merge block ~-2 ~2 ~-11 {Text1:'{"clickEvent":{"action":"run_command","value":"function fk:spawner/red/buy_skeleton"},"text":"skeleton"}',Text2:'["",{"text":"lvl "},{"score":{"name":"skeleton","objective":"spawner_red"}}]'}
...
data merge block ~-2 ~2 ~-10 {Text1:'{"clickEvent":{"action":"run_command","value":"function fk:spawner/red/buy_creeper"},"text":"creeper"}',Text2:'["",{"text":"lvl "},{"score":{"name":"creeper","objective":"spawner_red"}}]'}
