...
execute as @e[type=marker,tag=spawner_pink,limit=1] at @s if score buy spawner_red matches 1 run data merge block ~-2 ~2 ~-11 {Text2:'{"text":"lvl 1"}',Text4:'{"text":"lvl 2 160$"}'}
...
execute as @e[type=marker,tag=spawner_pink,limit=1] at @s if score buy spawner_red matches 2 run data merge block ~-2 ~2 ~-11 {Text2:'{"text":"lvl 2"}',Text4:'{"text":"lvl 3 320$"}'}
...
execute as @e[type=marker,tag=spawner_pink,limit=1] at @s if score buy spawner_red matches 3 run data merge block ~-2 ~2 ~-11 {Text2:'{"text":"lvl 3"}',Text4:'{"text":"lvl 4 640$"}'}
...
execute as @e[type=marker,tag=spawner_pink,limit=1] at @s if score buy spawner_red matches 4 run data merge block ~-2 ~2 ~-11 {Text2:'{"text":"lvl 4"}',Text4:'{"text":""}'}
