...
scoreboard players set auto_killer spawner_red 0
...
scoreboard players set auto_killer spawner_purple 0
...
scoreboard players set auto_killer spawner_black 0
...
scoreboard players set auto_killer spawner_yellow 0
...
scoreboard players set auto_killer spawner_blue 0
...
scoreboard players set auto_killer spawner_white 0
...
scoreboard players set auto_killer spawner_green 0
...
scoreboard players set auto_killer spawner_pink 0
