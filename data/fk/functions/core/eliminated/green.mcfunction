...
tellraw @a [{"text":"[","color":"white"},{"text":"FK","color":"gold"},{"text":"] ","color":"white"},{"text":"L'équipe ","color":"gray","bold":false},{"text":"VERTE","color":"green","bold":true},{"text":" a été éliminée !","color":"gray","bold":false}]
