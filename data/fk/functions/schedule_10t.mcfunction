...
scoreboard players add @e[type=marker,tag=Shelter] shelter_time 1
execute as @e[type=marker,tag=Shelter] if score @s shelter_time matches 20.. run function fk:custom_potions/remove_shelter
